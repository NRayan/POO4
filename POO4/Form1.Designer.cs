namespace POO4
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Campainha utilizando os 4 Pilares da Programação Orientada a Objetos";
